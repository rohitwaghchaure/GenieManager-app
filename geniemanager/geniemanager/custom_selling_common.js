	...
	setup_queries: function() {
		...
		if(this.frm.fields_dict["items"].grid.get_field('item_code')) {
			this.frm.set_query("item_code", "items", function(doc, cdt, cdn) {
				...
				return {
					query: "geniemanager.geniemanager.custom_selling_methods.item_query",
					filters: {
		...
		if(this.frm.fields_dict["items"].grid.get_field('location')) {
			this.frm.set_query("location", "items", function(doc, cdt, cdn) {
				var item = frappe.get_doc(cdt, cdn);
				return {
					query: "geniemanager.geniemanager.custom_selling_methods.location_query",
					filters: {
						"company": doc.company
					}
				}
